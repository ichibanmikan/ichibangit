			...
			while(true){
				...
				if(lsu.isLogin_admini(str1, str2)==-1){
                    ...
                    if(a==7){ cout<<"若需使用姓名查找用户输入1，若需使用账户名查找用户输入2"<<endl;int c;cin>>c;string aa;
                              if(c==1){cout<<"请输入用户名"<<endl;
                                       ...
                                       if(lsu.findStudent_Name(aa)==-1){cout<<"不存在该用户请重新输入"<<endl;}
                                            ...
                                            int ii;cin>>ii;st1.setBorrow(ii);cout<<"修改借阅情况成功"<<endl;
                                       }    }
                              }
                    ...
                    if(a==10){ cout<<"书名精确查找请输入1，ISBN码精确查找请输入2"<<endl;
                               cout<<"作者名模糊查找请输入3，类型模糊查找请输入4"<<endl;
                               cout<<"退出请输入5"<<endl;int yyy;cin>>yyy;string srr;
                                  while(true){
                                        if(yyy==1){cout<<"请输入需要查找的书名"<<endl;cin>>srr;
                                             if(ls1.findBook_name(srr)==-1){cout<<"所查找的书籍不存在，请重新输入"<<endl;}
                                        ...
                                        if(yyy==3){cout<<"请输入所需要查找的书籍类别"<<endl;cin>>srr;ls1.findBook_classF(srr);}
                                        if(yyy==4){cout<<"请输入所需要查找的作者"<<endl;cin>>srr;ls1.findBook_authorName(srr);}
                                        if(yyy==5){break;}
                                  }
                             }
                ...
                if(lsu.isLogin_user(str1,str2)==-1){
                    ...
                    while(true){
                        ...
                        if(a==3){ cout<<"书名精确查找请输入1，ISBN码精确查找请输入2"<<endl;
                                  ...
                                  while(true){if(tt==1){ cout<<"请输入需要查找的书名"<<endl;cin>>stt;
                                             if(ls1.findBook_name(stt)==-1){cout<<"所查找的书籍不存在，请重新输入"<<endl;}
                                                  ...
                                                  cout<<"--3--借阅本书---------------"<<endl;
                                                  cout<<"--4--归还本书---------------"<<endl;
                                                  cout<<"--5--退出-------------------"<<endl;int ttt;
                                                  while(true){
                                                    cin>>ttt;
                                                    if(ttt==1){cout<<bkk<<endl;}
                                                    if(ttt==2){cout<<bkk.getisBorrow()<<"（0为未被借走，1为已被借走）"<<endl;}
                                                    if(ttt==3){bkk.setBorrow(1);}
                                                    if(ttt==4){bkk.setBorrow(0);}
                                                    if(ttt==5){break;}
                                                  }
                                             }
                                             }
                                  if(tt==2){cout<<"请输入需要查找书籍的ISBN码"<<endl;cin>>stt;
                                  ...
                                  if(tt==3){cout<<"请输入所需要查找的书籍类别"<<endl;cin>>stt;ls1.findBook_classF(stt);}
                                  if(tt==4){cout<<"请输入所需要查找的作者"<<endl;cin>>stt;ls1.findBook_authorName(stt);}
                                  if(tt==5){break;}
                            }
                        }
                    }
